...
@Table(name = "cc_cmpt_spec_char_value")
public class CcCmptSpecCharValue extends CcCmptSpecCharValueKey implements Serializable {
    /**
     * 特征值是否为系统参数
            0：否
            1：是
    ...
    public boolean equals(Object that) {
        ...
        CcCmptSpecCharValue other = (CcCmptSpecCharValue) that;
