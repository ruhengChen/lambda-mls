...
@Table(name = "cc_cmpt_spec_char_rel")
public class CcCmptSpecCharRel extends CcCmptSpecCharRelKey implements Serializable {
    /**
     * 描述
     */
    ...
    public boolean equals(Object that) {
        ...
        CcCmptSpecCharRel other = (CcCmptSpecCharRel) that;
