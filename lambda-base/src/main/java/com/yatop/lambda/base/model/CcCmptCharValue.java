...
@Table(name = "cc_cmpt_char_value")
public class CcCmptCharValue extends CcCmptCharValueKey implements Serializable {
    /**
     * 特征值是否为系统参数
            0：否
            1：是
    ...
    public boolean equals(Object that) {
        ...
        CcCmptCharValue other = (CcCmptCharValue) that;
